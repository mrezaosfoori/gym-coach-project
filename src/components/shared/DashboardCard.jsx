...
export default function DashboardCard({ card }) {
  return (
    <div className="relative bg-white shadow-lg rounded-2xl  pt-16 cursor-pointer hover:shadow-2xl transition w-full">
      {/* تصویر */}
     ...
     <div className="flex justify-between border-b-2 px-6 py-4">
         <h2 className="text-center text-[18px] font-bold mb-4">{card.title}</h2>
         <img src={arrowDown} alt="" className="h-6 w-6 rotate-90" />
     </div>
     <div className="flex justify-between border-b-2 px-6  py-4">
         <h2 className="text-center text-[18px] font-bold mb-4">{card.users.length}</h2>
