...
export default function ExerciseForm({ close, disabled }) {
  ...
  return (
    <div className="p-2 bg-white rounded-md ">
      <div className=" flex justify-between items-center w-full py-4">
        <p className="">ایجاد تمرین جدید</p>

        <img
          src={icons.plus}
          alt=""
          className="rotate-45 w-4 h-4  cursor-pointer rounded-full hover:bg-slate-200 "
          onClick={() => close()}
        />
      </div>
